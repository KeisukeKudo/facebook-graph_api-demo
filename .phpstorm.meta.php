...
namespace PHPSTORM_META {
    ...
    */
    override(new \Illuminate\Contracts\Container\Container, map([
        '' => '@',
            'Crypto\API\Facebook\GraphAPI\Fetch\UserPort' => \App\Http\Adapters\API\Facebook\GraphAPI\Fetch\UserAdapter::class,
            'Crypto\Connection\Facebook\GraphAPI\AccessTokenPort' => \App\Http\Adapters\Connection\Facebook\GraphAPI\AccessTokenAdapter::class,
            'Crypto\OAuth\Facebook\AuthorizationPort' => \App\Http\Adapters\OAuth\Facebook\AuthorizationAdapter::class,
            'Crypto\OAuth\Facebook\UserPort' => \App\Http\Adapters\OAuth\Facebook\UserAdapter::class,
